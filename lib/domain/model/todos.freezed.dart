...
abstract class $TodosCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Todo> values, bool completed});
}
...
class _$_Todos implements _Todos {
  const _$_Todos({final List<Todo> values = const [], this.completed = false})
      : _values = values;
  ...
  @override
  String toString() {
    return 'Todos(values: $values, completed: $completed)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_values), completed);
...
abstract class _Todos implements Todos {
  const factory _Todos({final List<Todo> values, final bool completed}) =
      _$_Todos;
